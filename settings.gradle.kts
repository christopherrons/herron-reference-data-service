...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("common.api", "com.herron.exchange:common-api:1.0.188")
            library("common", "com.herron.exchange:common:1.0.188")
            library("integration", "com.herron.exchange:integration:1.0.8")
            library("integrations", "com.herron.exchange:integrations:1.0.8")
        }
