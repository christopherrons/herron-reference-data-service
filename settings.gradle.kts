...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("common.api", "com.herron.exchange:common-api:1.0.170")
            library("common", "com.herron.exchange:common:1.0.170")
            library("integration", "com.herron.exchange:integration:1.0.2")
            library("integrations", "com.herron.exchange:integrations:1.0.2")
        }
